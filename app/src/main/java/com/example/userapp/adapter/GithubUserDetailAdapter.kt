...
class GithubUserDetailAdapter(var githubUserDetails: ArrayList<BaseListItemOfGithubUserDetail>, private val listener: GithubUserDetailItemClickListener?) :
    BaseGithubUserDetailRecyclerAdapter<ArrayList<BaseListItemOfGithubUserDetail>>(githubUserDetails) {
    companion object {
